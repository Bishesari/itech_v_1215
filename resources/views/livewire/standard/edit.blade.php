...
new class extends Component {
    ...
    public float $nazari_h;
    public float $amali_h;
    public float $karvarzi_h;
    public float $project_h;
    public float $required_h;
    public float $sum_h;
    ...
    protected function rules(): array
    {
        return [
            ...
            'code' => ['required', 'min:5', Rule::unique('standards', 'code')->ignore($this->standard->id)],
    ...
    public function update_standard(): void
    {
        $this->calc_sum();
...
<div>
    ...
    <div class="inline-flex mt-2 mb-4">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item><span class="text-yellow-500">{{$standard->name_fa}}</span></flux:breadcrumbs.item>
    ...
    <form wire:submit.prevent="update_standard" class="grid mt-5 w-[400px] gap-y-4" autocomplete="off" autofocus>
